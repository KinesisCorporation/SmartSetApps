...
//    FRValue, FGValue, FBValue: integer;
    FRingHint, FSLHint, FSquareHint: string;
    ...
    procedure SetSquareHint(h: string);
  protected
//    procedure CreateWnd; override;
  ...
  published
    ...
    property SquarePickerHintFormat: string read FSquareHint write SetSquareHint;
...
procedure THSLRingPicker.SetSquareHint(h: string);
begin
  FSquareHint := h;
  FSLPicker.SLHintFormat := h;
  FSLPicker.SVHintFormat := h;
end;
