...
uses
  ...
  HTMLColors, mbColorConv, mbColorPickerControl, BGRABitmap, BGRABitmapTypes,
  dialogs;
...
begin
  ...
  //image.EllipseAntialias(r.Right, r.Bottom, 20, 20, ColorToBGRA(ColorToRGB(clwhite)), 3);
  ////image.RoundRectAntialias(r.Left,r.Top,r.Right, r.Bottom,30,30,clRed, 3);;
